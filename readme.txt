=== Meveto ===
Contributors: Meveto
Tags: meveto, password-less, authentication, access-management
...
- Use the **client ID** and **client secret** you got from Meveto and leave rest of the configuration values if any.
